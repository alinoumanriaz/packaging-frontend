      ...
      <div className="w-[400px] bg-white rounded-xl shadow-md">
        <div className="flex flex-col justify-center items-center space-y-4 p-10">
          <div className="flex flex-col justify-center items-center space-y-1">
            <div className="bg-white ring-1 ring-gray-300 rounded-full p-2 shadow-md">
              <TiUser className="size-12" />
            </div>
            <div className="font-semibold text-xl">
              {islogin ? <>Wellcome Back</> : <>Create Account</>}
            </div>
          ...
          <div className="w-full flex flex-col justify-center items-center">
            ...
            <button
              ...
              } flex justify-center items-center h-10 text-white w-full my-2 py-2 rounded-md`}
            >
              {loading ? (
                <>
                  <LoaderSpin color="bg-red-500" />
                </>
              ) : (
